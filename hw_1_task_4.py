...
if income > costs:
    print(f"The company is profitable. Profitability is {income / costs:.2f}")
    staff = int(input("Input company staff count: "))
    print(f"Income per worker is {income / staff:.2f}")
elif income == costs:
    print("The company is at a break-even point.")
else:
    print("The company is loss-making.")
